...
def input_all_test_file(in_dir, out_dir):
    ...
    for file_name in in_files:
        ...
        demo = Popen(["/Users/wangjian/code/C/dian/Monopoly/development/cmake-build-debug/development", in_dir+"/"+file_name, dump_file_name], stdin=PIPE, stdout=PIPE, stderr=STDOUT)
        time.sleep(0.1)
